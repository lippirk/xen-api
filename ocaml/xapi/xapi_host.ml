...
let replace_host_certificate ~__context ~host ~complete_task
...
let install_server_certificate ~__context ~host ~certificate ~private_key
  ...
  in
  replace_host_certificate ~__context ~host ~complete_task:true write_cert_fs
...
let reset_server_certificate ~__context ~host =
  ...
  replace_host_certificate ~__context ~host ~complete_task:false write_cert_fs
